    ...
    <div>
      ...
      {{--   <div class="col-md-6">
                        <div class="form-group {{ $errors->has('parent_topic') ? 'has-error' : '' }}">
                            ...
                            {!!Form::select('parent_topic', [''=>Lang::get('lang.select_a_parent_topic'),Lang::get('lang.help_topic')=>$topics->lists('topic','topic')->toArray(),Lang::get('lang.help_topic1')=>$topics->
                            lists('topic','topic')->toArray(),Lang::get('lang.help_topic2')=>$topics->
                            lists('topic','topic')->toArray(),Lang::get('lang.help_topic3')=>$topics->
                            lists('topic','topic')->toArray()],1,['class' => 'form-control']) !!}
