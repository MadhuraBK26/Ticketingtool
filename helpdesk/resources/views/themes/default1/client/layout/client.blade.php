                    ...
                    <div id="logo" class="site-logo text-center" style="font-size: 30px;">
                        ...
                        <a href="{!! $system->url !!}" rel="home">
                            ...
                            <a href="{{url('/')}}" rel="home">
                                ...
                                {!! $system->name !!}
                                @else
                                <b>COMPASSITES<b> SUPPORT</b> CENTER
                                @endif
                                @endif
                            </a>
                    </div><!-- #logo -->
                ...
                <div class="container">
                        ...
                        <div class="col-md-3">
                            <div class="widget-area">
                                <section id="section-newsletter" class="section">
                                    ...
                                    <div class="textwidget">
                                    {{--   <p>{!! $footer4->value !!}</p> --}}
                                      <p>Compassites Software Solutions,</p>
                                      <p>IBC Knowledge Park,Tower C,4th floor</p>
                                      <p>Bannerghatta Main Road,Bengaluru</p>
                                      <p>
                                    </div>
                                </section>
                            </div>
                    ...
                    <div class="row">
                        <div class="site-info col-md-6">
                            <p class="text-muted">{!! Lang::get('lang.copyright') !!} &copy; {!! date('Y') !!}  <a href="{!! $company->website !!}" target="_blank">{!! $company->company_name !!}</a>. {!! Lang::get('lang.all_rights_reserved') !!}. {!! Lang::get('lang.powered_by') !!} <a href="http://www.compassitesinc.com/"  target="_blank">Compassites</a></p>
                        </div>
