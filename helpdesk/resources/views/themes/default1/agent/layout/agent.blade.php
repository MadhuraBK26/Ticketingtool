...
<html>
    <head>
        ...
        <title>Compassites | HELP DESK</title>
    ...
    <body class="skin-blue fixed">
        <div class="wrapper">
            <header class="main-header">
                <a href="http://www.compassitesinc.com" class="logo"><img src="http://d3bnta759dhwji.cloudfront.net/wp-content/uploads/2017/05/compassites-logo.png"></a>
                <?php
